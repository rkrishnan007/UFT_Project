...
namespace Script
{
    ...
    public partial class WorkFlowScript
    {
        ...
        private void set_StServiceCallActivity4_checkpoints(STActivityBase activity)
        {
            ...
            // Checkpoint 2
            IVTDGetter actualValueGetter2 = new VTDXPathGetter(new VTDPropertyInfoBase("OutputEnvelope", "/*[local-name(.)='Envelope'][1]/*[local-name(.)='Body'][1]/*[local-name(.)='GetFlightsResponse'][1]/*[local-name(.)='GetFlightsResult'][1]/*[local-name(.)='Flight'][1]/*[local-name(.)='Airline'][1]"), XmlTypeCode.String, false);
            ...
            CpValObj valueExpectedObject2 = new CpValObj("AA", XmlTypeCode.String);
            ...
            CpValObj valueExpectedObject3 = new CpValObj("Los Angeles", XmlTypeCode.String);
            ValueCPRule cpRule3 = new ValueCPRule(valueActualObject3, valueExpectedObject3, StringCP.EqualTo, "=", false);

            // Checkpoint 4
            IVTDGetter actualValueGetter4 = new VTDXPathGetter(new VTDPropertyInfoBase("OutputEnvelope", "/*[local-name(.)='Envelope'][1]/*[local-name(.)='Body'][1]/*[local-name(.)='GetFlightsResponse'][1]/*[local-name(.)='GetFlightsResult'][1]/*[local-name(.)='Flight'][1]/*[local-name(.)='DepartureCity'][1]"), XmlTypeCode.String, false);
            ...
            CpValObj valueExpectedObject4 = new CpValObj("London", XmlTypeCode.String);
        ...
        private void set_ConcatenateStringsActivity10_checkpoints(STActivityBase activity)
        {
            // Checkpoint 1
            ...
            BindDirection actualBindDirection1 = new BindDirection(_flow.ConcatenateStringsActivity10, actualValueGetter1, actualValueSetter1);
            CpValObj valueActualObject1 = new CpValObj(actualBindDirection1, XmlTypeCode.String, false);


            CpValObj valueExpectedObject1 = new CpValObj("{Step.OutputProperties.StServiceCallActivity4.Body.GetFlightsResponse.GetFlightsR" +
                    "esult.Flight[1].FlightNumber}", bind_dir169);
        ...
        private void set_ConcatenateStringsActivity11_checkpoints(STActivityBase activity)
        {
            // Checkpoint 1
            IVTDGetter actualValueGetter1 = new VTDObjectGetter(new VTDPropertyInfoBase("Result"));
            IVTDSetter actualValueSetter1 = new VTDCheckpointSetter(XmlTypeCode.String);
            BindDirection actualBindDirection1 = new BindDirection(_flow.ConcatenateStringsActivity11, actualValueGetter1, actualValueSetter1);
            CpValObj valueActualObject1 = new CpValObj(actualBindDirection1, XmlTypeCode.String, false);


            CpValObj valueExpectedObject1 = new CpValObj("{Step.OutputProperties.StServiceCallActivity7.Body.CreateFlightOrderResponse.Crea" +
                    "teFlightOrderResult.OrderNumber}", bind_dir172);
            ValueCPRule cpRule1 = new ValueCPRule(valueActualObject1, valueExpectedObject1, RegularExpressionsCP.Regex, "Regex", false);
            activity.AddCheckpointRule(cpRule1);
        ...
        private void set_StServiceCallActivity8_checkpoints(STActivityBase activity)
        {
            ...
            CpValObj valueActualObject2 = new CpValObj(actualBindDirection2, XmlTypeCode.String, false);
            CpValObj valueExpectedObject2 = new CpValObj("Economy", XmlTypeCode.String);
            ValueCPRule cpRule2 = new ValueCPRule(valueActualObject2, valueExpectedObject2, StringCP.EqualTo, "=", false);
            ...
            CpValObj valueActualObject3 = new CpValObj(actualBindDirection3, XmlTypeCode.String, false);
            CpValObj valueExpectedObject3 = new CpValObj("Rakesh Krishnan", XmlTypeCode.String);
            ValueCPRule cpRule3 = new ValueCPRule(valueActualObject3, valueExpectedObject3, StringCP.EqualTo, "=", false);
            ...
            CpValObj valueExpectedObject4 = new CpValObj(bind_dir176);
            ...
            CpValObj valueExpectedObject5 = new CpValObj("2", XmlTypeCode.Int);
            ...
            CpValObj valueExpectedObject6 = new CpValObj(bind_dir177);
